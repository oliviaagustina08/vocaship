...
<body class="text-center">
    <div class="col-md 6">
    <form class="form-signin" action="<?= base_url('useri/tambah_aksi'); ?>" method="post">
       ...
       <h2 class="mb-3" style="font-size: 24px;" >Daftar</h2>
        ...
        <button class="btn btn-lg btn-primary btn-block" value="Loginn " type="submit">Daftar</button>

        <div class="regis-body">
            <div>Sudah punya akun?  <a href="<?= base_url();?>loginn">Masuk</a></div>
        </div>
...
?>   
    <!-- <div class="container">              
        <h2>Registrasi</h2>
            <?php echo form_open_multipart('useri/tambah_aksi'); ?>
